...
| `What did RUN-0001 do?` · `show me REC-0046` | a recorded run or proposal from the ledger: what was asked, what it proposed, who decided |
...
[evidence question](docs/assets/screenshots/07-evidence-question.png) · [question engine](docs/assets/screenshots/08-question-engine.png) ·
[build comparison](docs/assets/screenshots/09-build-comparison.png)
